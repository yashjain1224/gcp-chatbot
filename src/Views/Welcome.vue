<template>
    <div class="overlay">
        ...
        <img v-else class="app-icon" src="https://images.idgesg.net/images/article/2018/02/artificial_intelligence_ai_virtual_assistant_robot_chatbot_thinkstock_856909876-100749925-large.jpg" :alt="app.displayName">
